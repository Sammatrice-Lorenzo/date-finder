...
const formSchema = z.object({
  date: z.union([z.string({ required_error: fr.ERROR.FORM_REQUEST_ACTIVITY.MISSING_DATE }), z.date()])
  .transform((val) => {
    if (!val) return null
  ...
  'author-name': z.string({ required_error: fr.ERROR.FORM_REQUEST_ACTIVITY.MISSING_AUTHOR_NAME }),
  'author-email': z.string({
    required_error: fr.ERROR.FORM_REQUEST_ACTIVITY.MISSING_EMAIL,
  }).email(fr.ERROR.FORM_REQUEST_ACTIVITY.INVALID_EMAIL),
  'target-name': z.string({ required_error: fr.ERROR.FORM_REQUEST_ACTIVITY.MISSING_TARGET_NAME }),
})
